...
(function(global, factory) {
  ...
  */
  ...
  function Dexie(dbName, options) {
    ...
    this.on.ready.subscribe = override(this.on.ready.subscribe, function(
      subscribe
    ) {
    ...
    function BulkErrorHandlerCatchAll(errorList, done, supportHooks) {
      return (supportHooks
        ? hookedEventRejectHandler
        : eventRejectHandler)(function(e) {
        errorList.push(e);
        done && done();
      });
    }
    ...
    props(Table.prototype, {
      ...
      bulkDelete: function(keys$$1) {
        if (this.hook.deleting.fire === nop) {
          return this._idbstore(READWRITE, function(
            resolve,
            reject,
            idbstore,
            trans
