            ...
            if (node.deleteTimeStamp && node.deleteTimeStamp < Date.now()) {
              ...
              if (localStorage) {
                localStorage.removeItem(
                  'Dexie.Observable/deadnode:' + node.id + '/' + db.name
                );
              }
              ...
              db._intercomm
                ...
                .modify(function(msg) {
                  if (msg.wantReply) msg.destinationNode = ourSyncNode.id;
